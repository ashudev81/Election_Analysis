...
file_to_save = os.path.join("analysis", "election_result.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_result = (f"{county_name}: {vote_percentages:.1f}% ({vote:,})\n")
        ...
        if (vote>largest_county_count) and (vote_percentages>largest_county_percentage):

            largest_county_count= vote
            largest_county_percentage=vote_percentages
    ...
    #        f"winning percentage: {largest_county_percentage:.1f}%\n"
    #        f"-----------------------------------------\n")
